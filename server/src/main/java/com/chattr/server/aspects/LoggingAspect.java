...
/**
 * Aspect for logging execution of service and controller layer methods. Excludes utility classes
 * and performance-critical methods from logging.
 */
@Aspect
@Component
@Slf4j
