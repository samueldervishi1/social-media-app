...
/**
 * REST controller for managing user profiles, including updates, password changes, deletion, and
 * activation.
 */
@RestController
...
public class ProfileController {
  ...
  public ResponseEntity<?> isBlocked(
      @RequestParam String blockerId, @RequestParam String targetId) {
  ...
  public ResponseEntity<User> updateUser(
      @PathVariable String userId, @RequestBody User updatedUser) {
    User updated = profileService.updateProfile(userId, updatedUser);
    activityLogService.log(
        updated.getUsername(), "PROFILE_UPDATE", "Profile updated for user ID: " + userId + ".");
    return ResponseEntity.ok(updated);
  }

  @PutMapping("/{userId}/update/password")
  public ResponseEntity<String> updatePassword(
      @PathVariable String userId, @RequestBody PasswordUpdateRequest request) {
    profileService.updatePassword(userId, request.getOldPassword(), request.getNewPassword());
    activityLogService.log(
        userId, "PASSWORD_UPDATE", "Password updated for user ID: " + userId + ".");
  ...
  public ResponseEntity<String> deleteUser(@PathVariable String userId) {
    ...
    activityLogService.log(
        userId, "PROFILE_DELETE", "Profile deleted for user ID: " + userId + ".");
  ...
  public ResponseEntity<String> deactivateUser(@PathVariable String userId) {
    ...
    activityLogService.log(
        userId, "PROFILE_DEACTIVATE", "Profile deactivated for user ID: " + userId + ".");
  ...
  public ResponseEntity<String> reactivateUser(@PathVariable String userId) {
    ...
    activityLogService.log(
        userId, "PROFILE_REACTIVATE", "Profile reactivated for user ID: " + userId + ".");
