...
public class FollowController {
    ...
    @GetMapping("/mutual")
    public ResponseEntity<?> isMutualFollow(@RequestParam String userAId, @RequestParam String userBId) {
    ...
    public ResponseEntity<?> getMutualConnections(@RequestParam String viewerId, @RequestParam String profileId) {
    ...
    public ResponseEntity<?> rejectFollowRequest(@RequestParam String requestId, @RequestParam String receiverId) {
