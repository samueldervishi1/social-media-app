...
public class HealthCheckController {
  ...
  public HealthCheckController(
      HealthLogService healthLogService, ActivityLogService activityLogService) {
  ...
  public ResponseEntity<Map<String, Object>> checkHealth() {
    ...
    try {
      ...
      activityLogService.log(
          "anonymous", "HEALTH_CHECK_ERROR", "Health check failed: " + e.getMessage());
  ...
  public ResponseEntity<Map<String, Object>> detailedHealthCheck() {
    ...
    try {
      ...
      activityLogService.log(
          "anonymous", "DETAILED_HEALTH_CHECK", "Detailed health check performed");
