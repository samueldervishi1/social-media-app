...
public class CommentsController {
    ...
    public ResponseEntity<Comment> getCommentById(@PathVariable String postId, @PathVariable String commentId) {
        ...
        activityLogService.log(comment.getUserId(), "COMMENT_VIEW", "User used method comment by ID" + comment.getContent());
    ...
    public ResponseEntity<Comment> createComment(@PathVariable String userId,
        ...
        activityLogService.log(userId, "COMMENT_CREATE", "User created comment with ID: " + created.getId() + " for post with ID: " + postId + ".");
    ...
    public ResponseEntity<String> deleteComment(@PathVariable String postId,
        ...
        activityLogService.log(commentId, "COMMENT_DELETE", "Comment with ID: " + commentId + " deleted from post with ID: " + postId + ".");
