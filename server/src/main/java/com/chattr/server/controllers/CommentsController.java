...
public class CommentsController {
  ...
  public CommentsController(
      CommentsService commentsService, ActivityLogService activityLogService) {
  ...
  public ResponseEntity<Comment> createComment(
      @PathVariable String userId, @PathVariable String postId, @RequestBody Comment comment) {
