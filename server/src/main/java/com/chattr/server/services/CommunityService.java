...
/**
 * Service class for managing communities and community posts. Handles creation, updates,
 * joining/unjoining, and retrieval.
 */
@Service
public class CommunityService {
  ...
  public Community createCommunity(
      String name, String ownerId, String description, List<Faq> faqs) {
    communityRepository
        .findByName(name)
        .ifPresent(
            existing -> {
  ...
  public Community updateCommunity(
      String communityId, String newName, String description, List<Faq> faqs) {
  ...
  public int getUserCountForCommunity(String name) {
    try {
      ...
      loggingService.logError(
          "CommunityService",
          "getUserCountForCommunity",
          "Error fetching user count for community '" + name + "'",
          e);
  ...
  public Community getCommunityById(String communityId) {
    return communityRepository
        ...
        .orElseThrow(
            () ->
                new CustomException(404, String.format(Messages.COMMUNITY_NOT_FOUND, communityId)));
  }
  ...
  public Community getCommunityByName(String name) {
    return communityRepository
        .findByName(name)
        .orElseThrow(
            () -> new CustomException(404, String.format(Messages.COMMUNITY_NOT_FOUND, name)));
  }
  ...
  public List<Community> getCommunitiesByUserId(String userId) {
    try {
      ...
      loggingService.logError(
          ...
          "Error fetching communities for user '" + userId + "'",
          e);
      throw new CustomException(500, String.format(Messages.ERROR_500));
    }
  }
