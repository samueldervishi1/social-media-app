...
public class ChatBotService {
  ...
  public Map<String, Object> getResponses(String message) {
    try {
      ...
      loggingService.logInfo(
          "ChatBotService", "getResponses", "Model API response: " + response.getBody());
  ...
  private Map<String, Object> buildRequestBody(String message) {
    return Map.of(
        ...
        "messages",
        List.of(
            Map.of("role", "user", "content", List.of(Map.of("type", "text", "text", message)))));
  }

  /** Parses the model API response and extracts the answer. */
  private Map<String, Object> parseModelResponse(
      Map<String, Object> responseBody, String userMessage) {
