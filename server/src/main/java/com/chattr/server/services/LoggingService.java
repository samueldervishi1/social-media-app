...
/**
 * Service for comprehensive logging of all application activities. Stores logs locally in JSON
...
public class LoggingService {
  ...
  public void logError(
      String service, String method, String message, Object data, Exception exception) {
  ...
  public void logExecutionTime(String service, String method, long executionTimeMs) {
    ...
    logEvent(
        ...
        service,
        method,
        String.format("Method executed in %dms", executionTimeMs),
        data,
        null);
  }
        ...
        () -> {
          try {
            Map<String, Object> logEntry =
                createLogEntry(level, service, method, message, data, exception);
  ...
  private void logToConsole(String level, Map<String, Object> logEntry) {
    String message =
        String.format(
            "[%s.%s] %s", logEntry.get("service"), logEntry.get("method"), logEntry.get("message"));
  ...
  public void logUserActivity(String userId, String username, String activity, String ipAddress) {
    ...
    logEvent(
        ...
        "UserActivity",
        activity,
        String.format("User %s performed: %s", username, activity),
        data,
        null);
  }
