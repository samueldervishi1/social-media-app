...
/**
 * Service responsible for managing user posts, including creation, retrieval, and soft deletion.
 */
@Service
...
public class PostService {
  ...
  public List<Post> getTopPosts(int limit) {
    ...
    return allPosts.stream()
        ...
        .sorted(
            (p1, p2) -> Integer.compare(p2.getLikedUserIds().size(), p1.getLikedUserIds().size()))
        .limit(limit)
        .toList();
  }
