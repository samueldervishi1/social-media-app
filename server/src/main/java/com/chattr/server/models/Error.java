...
public class Error {
  ...
  public int hashCode() {
    return Objects.hash(
        code, reason, message, status, referenceError, baseType, schemaLocation, type);
  }
  ...
  public String toString() {
    ...
    return "class Error {\n"
        ...
        + "\n"
        + "    referenceError: "
        + toIndentedString(referenceError)
        + "\n"
        + "    baseType: "
        + toIndentedString(baseType)
        + "\n"
        + "    schemaLocation: "
